...
class UpdateCreate(models.Model):
    # ?bu class tan crated ve updateyi inherit olarak kullandırıyoruz
...
class Purchases(UpdateCreate):
    ...
    firm = models.ForeignKey(
        Firm, on_delete=models.SET_NULL, null=True, related_name='purchases')
    brand = models.ForeignKey(
        Brand, on_delete=models.SET_NULL, null=True, related_name='b_purchases')
    product = models.ForeignKey(
        Product, on_delete=models.SET_NULL, null=True, related_name='purchase')
...
class Sales(UpdateCreate):
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
    brand = models.ForeignKey(
        Brand, on_delete=models.SET_NULL, null=True, related_name='b_sales')
    product = models.ForeignKey(
